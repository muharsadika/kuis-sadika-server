                    ...
                    <div class="card-body">
                        <form action="{{ route('avatars.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control @error('avatar_url') is-invalid @enderror" name="avatar_url">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('avatar_name') is-invalid @enderror" name="avatar_name" value="{{ old('avatar_name') }}" placeholder="Masukkan Avatar name">
                            
                                <!-- error message untuk avatar_name -->
                                @error('avatar_name')
                                    <div class="alert alert-danger mt-2">
                                        {{ $message }}
                                    </div>
